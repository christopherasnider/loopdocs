...
!!!note If your language is not listed and you want to start translating Loopdocs into a new language, please submit an issue on github \[here\](https://www.github.com/LoopDocs/loopdocs/issues/new?title=New language request&body=Can you please add [ENTER COUNTRY] for translation.).
...
!!!important Remember to click the save button otherwise your translation will not get saved.
...
!!!info It is standard practice to use the source language for comments -> english.
