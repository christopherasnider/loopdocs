...
![../img/apns-copy-key.png](img/apns-add-key.png)
...
![../img/apns-copy-key2.png](img/key-apns.png)

4. In the screen that follows, click the blue "Register" button.

![../img/apns-vars.png](img/apns-register.png)
...
![../img/apns-open2.png](img/apns-download.png)
...
![../img/override_vars_complete.png](img/apns-open.png) </br></br>

![../img/careportal-overrides.PNG](img/apns-textedit.png)
...
![../img/override_notification.jpg](img/apns-copy-key.png)
