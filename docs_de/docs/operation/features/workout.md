...
* Enter a target range (**make sure to enter the target range low-high** or you could crash your app...do not enter the range high-low.) If you do not enter a target range, Loop will use your existing scheduled target ranges. If you do not enter a target range, Loop will use your existing scheduled target ranges.
